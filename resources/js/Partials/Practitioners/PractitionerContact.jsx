...
export default function ({className = 'bg-gradient-to-br from-primary-100 to-primary-50'}) {
    ...
    return (
        <div className={`relative ${className} `}>
            <div className="absolute top-0 right-0 left-0 bottom-0 z-0"></div>
            
            <div className="md:py-20 py-10 pt-10 md:pt-20 px-4 z-10 relative">
                <div className="md:w-4/12 mx-auto space-y-5">
                    <div className='text-center space-y-4'>
                        <h3 className="text-2xl md:text-3xl font-semibold">Get in Touch</h3>

                        <div>
                            <p className='text-muted'>For the fastest response, please fill out the form below. This will be routed directly to our practitioner support team.</p>
                        </div>
                    </div>

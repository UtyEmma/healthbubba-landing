            ...
            <div className="max-w-7xl mx-auto px-4">
                <div class="space-y-5 mb-10">
                    <div className="flex justify-center">
                        <div className="mx-auto inline-flex border bg-white shadow font-medium text-sm items-center space-x-1 p-2 px-3 rounded-[50px]">
                    ...
                    <div className="text-center md:w-2/4 mx-auto mb-20 space-y-5">
                        <h2 className="text-3xl font-semibold">It’s as easy as <br className='md:block hidden' /> waving a magic wand</h2>
                    ...
                    <div className="col-span-3">
                        <div className="border-t border-t-[#0470D1] space-y-7 pt-7 bg-white min-h-full flex flex-col justify-between shadow">
                            <div className="md:px-7 px-4">
                                ...
                                <p className="text-muted text-[14px]">View your consultation timings and book appointments for clinic or online consultations without having to make phone calls. They also receive automated alerts about the status of their appointment requests.</p>
                            </div>
                            <div className="px-10">

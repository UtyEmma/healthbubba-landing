    ...
    return (
        <div className='relative py-5'>
            <div style={{
                ...
                <div className={active ? 'md:rounded-3xl rounded-lg min-h-[300px] shadow-lg bg-white bg-opacity-90 p-5 md:p-16 space-y-5 relative z-50' : 'blur-sm overflow-hidden'}>
                    <div className={`space-y-3 md:space-y-5`}>
                        ...
                        <div className="justify-start items-center gap-2 md:gap-4 inline-flex">
                            <img className={`h-11 w-11 md:h-14 md:w-14 rounded-full object-cover ${classes.image}`} src={avatar} />

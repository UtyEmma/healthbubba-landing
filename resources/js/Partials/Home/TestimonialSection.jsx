            ...
            <div className="flex items-center justify-center px-4">
                <div className="space-y-5 md:space-y-10 flex flex-col items-center">
                    ...
                    <div className="text-center md:w-4/6 mx-auto space-y-4">
                        ...
                        <p className="text-muted text-sm md:text-base md:w-4/5 mx-auto">Listen to the buzz about us and discover why HealthBubba is making waves in the health tech world. Our innovative approach to healthcare is revolutionizing how people access medical services.</p>
                    </div>

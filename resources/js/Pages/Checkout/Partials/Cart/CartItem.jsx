    ...
    return (
        <div className="grid grid-cols-4 items-center px-4 py-3 border-b border-gray-200">
            <div className={'col-span-3 md:col-span-2 flex space-x-3 items-center'}>
                ...
                <p className="font-medium text-sm md:text-base">{item.test_package_name}</p>
            </div>
            <div className='hidden md:block'>
                <p className="font-medium text-sm md:text-base">NGN {item.test_package_price}</p>
            </div>
            <div class={'text-end md:pe-5 flex items-center justify-end space-x-3'}>
                <p className="font-medium text-sm md:text-base">NGN {item.test_package_price * item.quantity}</p>

        ...
        <div className='max-w-7xl mx-auto py-10 md:py-20 px-4'>
            ...
            <div className='flex flex-col items-center space-y-10 justify-center'>
                <div className='text-center space-y-2'>
                    <h2 className='text-2xl md:text-3xl font-semibold'>Yay! You have succesfully completed your order!</h2>
                    <p className="text-muted md:text-xl">Chat with us or call 08116848839 if you need any help.</p>
                </div>

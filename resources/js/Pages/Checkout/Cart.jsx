            ...
            <div className="border-y border-gray-200 md:pl-36">
                <div className="grid md:grid-cols-5 divide-x">
                    <div className="md:col-span-3 divide-y py-5">
                        ...
                        <div className="grid grid-cols-4  py-3 px-4 border-b border-gray-200">
                    ...
                    <div className="md:col-span-2 bg-gray-50 p-5 md:px-10 px-4">
                        <div className='hidden md:block'>
                            <button onClick={checkout} className="btn btn-primary w-full">Checkout <PlayIcon class={'text-white text-opacity-70 w-6 h-6'} /></button>
                        </div>

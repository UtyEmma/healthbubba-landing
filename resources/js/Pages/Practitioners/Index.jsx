    ...
    return (
        <>
            ...
            <GuestLayout hideGap className="!pt-0" >
                <div className="h-[80vh] md:h-[100vh] flex items-center justify-center relative bg-no-repeat bg-center bg-cover bg-[url(/assets/imgs/female-doctor-in-office.png)] px-2">
                    ...
                    <div className='text-center max-w-6xl mx-auto space-y-5 md:space-y-10 pt-20 z-10'>
                        <div className=" md:space-y-5 space-y-2  text-white">
                            <h1 className='md:text-7xl text-4xl font-bold '>Flexible, Convenient Healthcare at Your Fingertips</h1>
                        ...
                        <div className="space-x-4">
                            <a href={props.urls.web.home} target='__blank' className="btn btn-primary shadow-[#0000001A]" >Get Started <PlayIcon class={'text-white text-opacity-80 w-5 h-5'} /> </a>
                ...
                <section className="max-w-7xl mx-auto py-10 text-center">
                    ...
                    <div className='relative'>
                        <img src="/assets/imgs/healthbubba-doctors-wheel.png" className="md:h-48 object-contain mx-auto -mb-10 fade" alt="" />
                    </div>
                    <div className="shadow-sm mt-5 md:mt-0 shadow-gray-100 border-2 rounded-[50px] inline-flex items-center gap-2 md:gap-3 text-secondary mx-auto w-auto px-2 md:px-8 text-center py-1 text-sm">
